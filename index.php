...
function edit_price($price) {
    $round_price = ceil($price);
    if ($round_price > 1000) {
        $round_price = number_format ($price, 0, ",", " ");
    }
    $with_ruble = $round_price . " " . "₽";
    return $with_ruble;
}
        ...
        <ul class="lots__list">
            ...
            <li class="lots__item lot">
                <div class="lot__image">
                    <img src="<?=$item['image']; ?>" alt="<?=$item['alt']; ?>" width="350" height="260">
                </div>
                <div class="lot__info">
                    ...
                    <div class="lot__state">
                        <div class="lot__rate">
                            ...
                            <span class="lot__cost"><?=edit_price($item['price']); ?></span>
                        </div>
